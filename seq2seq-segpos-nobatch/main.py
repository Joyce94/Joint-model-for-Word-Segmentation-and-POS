...
import model.decode_nobatch as decode_nobatch
import train
import torch
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--config-file', default='/data/disk1/song/CWS/seq2seq-segpos2/examples/config.cfg')
    ...
    decode = decode_nobatch.Decode(config, data)
    if data.use_cuda:
        encode = encode.cuda()
        decode = decode.cuda()
