...
class Configurable(object):
    ...
    @property
    def pretrained_bicharEmb_file(self):
        return self._config.get('Data', 'pretrained_bicharEmb_file')
    @property
    ...
    @property
    def save_encode_path(self):
        return self._config.get('Save', 'save_encode_path')
    @property
    def save_decode_path(self):
        return self._config.get('Save', 'save_decode_path')

    @property
    def load_dir(self):
        return self._config.get('Save', 'load_dir')
    @property
    def load_encode_path(self):
        return self._config.get('Save', 'load_encode_path')
    @property
    def load_decode_path(self):
        return self._config.get('Save', 'load_decode_path')
    ...
    @property
    def bichar_dims(self):
        return self._config.getint('Network', 'bichar_dims')

    @property
    def wordlen_dims(self):
        return self._config.getint('Network', 'wordlen_dims')
    @property
    def char_type_dims(self):
        return self._config.getint('Network', 'char_type_dims')
    @property
    def pos_dims(self):
        return self._config.getint('Network', 'pos_dims')

    @property
    def linear_hiddens(self):
        return self._config.getint('Network', 'linear_hiddens')
    @property
